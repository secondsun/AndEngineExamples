...
public class SpriteBenchmark extends BaseBenchmark {
	...
	public EngineOptions onCreateEngineOptions() {
		...
		return new EngineOptions(true, ScreenOrientation.LANDSCAPE_SENSOR, new RatioResolutionPolicy(SpriteBenchmark.CAMERA_WIDTH, SpriteBenchmark.CAMERA_HEIGHT), camera);
	}
...
//		this.drawUsingSpritesWithSharedVertexBuffer(scene);
	...
	private void drawUsingSpriteBatch(final Scene pScene) {
		...
		final SpriteBatchWithoutColor spriteBatch = new SpriteBatchWithoutColor(this.getVertexBufferObjectManager(), this.mFaceTexture, SpriteBenchmark.SPRITE_COUNT, DrawType.STATIC);
